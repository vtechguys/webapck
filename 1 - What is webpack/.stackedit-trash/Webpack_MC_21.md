...
The first one image-webpack-loader loader is used to compress image and then urls loader decide based on size of image that this needs to be included in bundle.js or as assets.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODQxNTI1OTJdfQ==
-->